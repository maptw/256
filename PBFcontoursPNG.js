...
//執行git remote add origin https://<username>:<token>@github.com/<username>/256.git 或↓(若起初並無origin設定，256為倉庫名)
//執行git remote set-url origin https://<username>:<token>@github.com/<username>/256.git 或↑(若起初已有origin設定，256為倉庫名)
